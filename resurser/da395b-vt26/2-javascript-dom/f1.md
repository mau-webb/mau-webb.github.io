...
<div class="frame">
    <embed
        src="../../assets/pdf/VT26-JavaScript-DOM.pdf"
...
[Ni kan ladda ner föreläsningen i PDF här](../../assets/pdf/VT26-JavaScript-DOM.pdf)

## Dagens exempel

Ni kan surfa till exemplet <a href="../ex/">här</a> (med CSS-kod som bonus).
