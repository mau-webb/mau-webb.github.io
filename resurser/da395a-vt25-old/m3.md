...
När ni noggrant kontollerat att **alla krav** för båda uppgifterna är uppfyllda & att er lösning **motsvarar resultatvideon** så lämnar ni in (sen inlämning) för den/de ordinarie uppgifterna på Canvas som ni kompletterar.
