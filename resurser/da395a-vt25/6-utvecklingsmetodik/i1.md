...
**Om du kör Windows**: Ibland fungerar inte geckodriver rakt av på Windows. Om det händer dig, ladda ner [geckodriver](https://github.com/mozilla/geckodriver/releases/download/v0.34.0/geckodriver-v0.34.0-win32.zip) och packa upp *geckodriver.exe* direkt i den katalog där du kör din uppgift. Glöm inte att lägga till den i *.gitignore*. {: .info}
