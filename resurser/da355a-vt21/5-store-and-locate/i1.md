...
Lösningsförslag för uppgiften hittar ni [här](../../assets/4.a.zip).
{: .info}
...
{: .info}
Mallen för denna uppgift (inkluderar kod ovan) laddar ni ner här [`assignment-4a-start-kit.zip`](../../assets/assignment-4a-start-kit.zip).
