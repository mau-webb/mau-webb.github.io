...
Här finns [lösningsförslag](../../assets/kod/3.a.zip) till inlämningsuppgiften (som ni kan använda som inspiration till er *peer review*)
{: .info}
...
<html>
    ...
    <body>
        ...
        <script src="sökväg/till/jquery-4.0.0.min.js"></script>
...
Notera de två olika metoderna.

**Metod 1:** Gå till [jquery.com/download](https://jquery.com/download/) och välj att ladda ner `Download jQuery 4.0.0` <br>
**Metod 2:** Gå till [releases.jquery.com](https://releases.jquery.com/) och kopiera `<script>`-elementet för den senaste versionen av jQuery (*uncompressed* eller *minified* -- använd inte *slim* om du gärna vill använda Ajax i uppgift 3.b).

Glöm inte heller att skapa er egen JavaScript-fil och inkludera den utöver jQuery. 
...
* Produkten av de två tal som användaren matar in ska beräknas när användaren skrivit in två siffror (man ska alltså inte behöva klicka på någon knapp). *Tips* - Titta på [`keyup`](https://api.jquery.com/keyup/)-händelsen.
* Produkten ska bara räknas ut när det finns två tal inskrivna.
