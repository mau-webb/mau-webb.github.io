...
**Tips om du kör React:** För att snabbt kunna komma igång med React finns hjälpmedlet [Vite](https://react.dev/learn/build-a-react-app-from-scratch). Med detta kan ni enkelt starta upp ett nytt projekt för att sedan köra igång en utvecklingsmiljö, utan att behöva göra mycket på egen hand.
{: .info}
...
<MovieApplication>
    ...
    <MovieList> // Kan vara en lista <ul> också
        <Movie />
        <Movie />
        <Movie />
        <!-- ... -->
