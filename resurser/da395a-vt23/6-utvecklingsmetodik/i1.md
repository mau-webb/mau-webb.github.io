...
**Problem med Jasmine?**: I en del fall kommer Jasmine att importeras två gånger, eftersom Jest och Selenium använder två separata versioner. Om du får problem med det, testa att först ta bort Jasmine med [``npm uninstall``](https://docs.npmjs.com/cli/v8/commands/npm-uninstall) och kör testerna igen. Funkar inte det, testa då att ta bort Jest; Selenium borde hantera det beroendet med.
{: .info}
