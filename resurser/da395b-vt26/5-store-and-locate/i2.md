...
Här finns [lösningsförslag](../../assets/kod/4.b.zip) till inlämningsuppgiften (som ni kan använda som inspiration till er _peer review_)
{: .info}
...
Tänk på att ni får tillbaka hastigheten i _meter per sekund_, men vi vill för användaren visa hastigheten som _km per timme_. Använd följande formel för att åstadkomma detta:
...
{: .info}
Använd gärna tjänsten [`WebShare`](http://webshare.mah.se/) (ni behöver ha **https**) för att ladda upp er webbsida till internet (för att kunna komma åt den via mobilen när ni ska testa _del 3_ av uppgiften)
