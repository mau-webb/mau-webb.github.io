...
- Komponenter
    ...
    - En [`modal`](https://getbootstrap.com/docs/5.1/components/modal/) med ett [`formulär`](https://getbootstrap.com/docs/5.1/forms/overview/) i.
...
### Viktiga detaljer för att testerna ska gå igenom

1. Popovern ska aktiveras genom händelsen `click`
2. Era *breakpoints* ska sättas på kolumnnivå (alltså t.ex. `col-md-4`)
