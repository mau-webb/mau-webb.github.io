...
**Viktigt** - Utgå från [dessa mallar](../../assets/start-3a.zip) när ni gör uppgifterna nedan.
{: .info}
...
* **Ändra inte** i den givna HTML-koden från `start-3a.zip`
...
* Er html-fil ska heta `assignment_3.html`.
* Er lösning följer uppgiftsbeskrivningen ovan

---

### Bonus (extrauppgift) - Ej del av inlämningsuppgiften
...
* Din HTML-fil är korrekt namngivna enligt instruktioner ovan
